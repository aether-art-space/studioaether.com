...
const sourcePages = [
  ...
  route("/post-booking", "en", "Post-booking confirmation", "post-booking | Aether Art Space", "Thanks for booking!", "/hu/post-booking", { nav: false, indexable: false, priority: "High", action: "PRESERVE URL; conversion-flow review", disposition: "preserve-pending-content-review", section: "booking", description: "Thank you for booking aether art space photostudio for your shoot! We will be waiting for you." }),
  route("/hu/post-booking", "hu", "Post-booking confirmation", "Poszt-foglalás | Aether Art Space", "Köszönjük foglalásod!", "/post-booking", { nav: false, indexable: false, priority: "High", action: "PRESERVE URL; conversion-flow review", disposition: "preserve-pending-content-review", section: "booking", description: "" }),
